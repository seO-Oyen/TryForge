		...
		<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row"
			...
			<div class="navbar-brand-wrapper d-flex justify-content-center"
				...
				<div
					...
					<a class="navbar-brand brand-logo" href="${path}/adMain"> <img
						src="${path}/template/images/try_forge01.jpg" alt="logo"
						style="width: 100%" /> <!-- <span>TryForge</span> -->
					</a> <a class="navbar-brand brand-logo-mini" href="${path}/adMain">
			...
			<div
				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item nav-date dropdown"><a
						...
						href="javascript:;">
							<h6 class="date mb-0" id="currentDate"></h6> <i
				...
				<ul class="navbar-nav mr-lg-2">
					...
					<li class="nav-item">
						<div class="d-flex align-items-baseline">
							...
							<p id="detailText" class="mb-0"
								style="font-size: 20px; margin-left: 10px;"></p>
						</div>
					</li>
				</ul>
				<!-- 검색창 => <ul>은 공간때문에 냅둠 -->
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					<li class="nav-item"><a class="nav-link"
						href="${path}/projList"> <i class="mdi mdi-airplay"
							style="width: 20px; height: 20px;"></i> <span class="menu-title">프로젝트관리</span>
					...
					<li class="nav-item"><a class="nav-link" href="${path}/task">
							<i class="mdi mdi-file-export" style="width: 20px; height: 20px;"></i>
							<span class="menu-title">업무할당관리</span> <!-- <i class="menu-arrow"></i> -->
					</a> <!-- <div class="collapse" id="form-elements">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a class="nav-link"
									href="pages/forms/basic_elements.jsp">Basic Elements</a>
					...
					<li class="nav-item"><a class="nav-link" href="#charts"> <i
							...
							style="width: 20px; height: 20px;"></i> <span class="menu-title">업무현황관리</span>
					...
					<li class="nav-item"><a class="nav-link" href="#tables"> <i
							class="mdi mdi-file-check"></i> <span class="menu-title">결재관리</span>
							<!-- <i class="menu-arrow"></i> -->
					...
					<li class="nav-item"><a class="nav-link"
						href="${path}/noticeList"> <i class="mdi mdi-tooltip-text"
					...
					<li class="nav-item"><a class="nav-link"
						href="${path}/insertUser"> <i
							class="mdi mdi-account-multiple-plus"
							style="width: 20px; height: 20px;"></i> <span class="menu-title">사용자
								초대</span>
					</a></li>
					...
					<li class="nav-item"><a class="nav-link"
						href="${path}/userIndex"> <i class="mdi mdi-account-convert"
							style="width: 20px; height: 20px;"></i> <span class="menu-title">일반유저페이지</span>
							<!-- <i class="menu-arrow"></i> -->
					</a> <!-- <div class="collapse" id="auth">
    <!-- partial:partials/_navbar.html --> <!-- 상단바 -->
						<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row"
							style="border-bottom: none;">
							<!-- 왼쪽 상단 로고 -->
							<div class="navbar-brand-wrapper d-flex justify-content-center"
								...
								<div
									...
									<a class="navbar-brand brand-logo" href="${path}/adMain"> <img
										src="${path}/template/images/try_forge01.jpg" alt="logo"
										style="width: 100%" /> <!-- <span>TryForge</span> -->
									</a> <a class="navbar-brand brand-logo-mini" href="index.jsp">
										<img src="${path}/template/images/try_logo.jpg" alt="logo"
										style="width: 100%;" />
									</a>
									<button class="navbar-toggler navbar-toggler align-self-center"
								...
								<ul class="navbar-nav mr-lg-2">
									<li class="nav-item nav-profile dropdown"><a
										...
										id="profileDropdown"> <img
											src="${path}/template/images/faces/face5.jpg" alt="profile" />
											<span class="nav-profile-name">${loginMem.member_name}
												님</span>
									</a>
										<div class="dropdown-menu dropdown-menu-right navbar-dropdown"
											aria-labelledby="profileDropdown">
								...
								<ul class="navbar-nav navbar-nav-right">
									...
									<li class="nav-item dropdown"><a
										...
										<div
											...
											<a class="dropdown-item preview-item">
												<div class="preview-thumbnail">
													<img src="${path}/template/images/faces/face4.jpg"
												...
												<div class="preview-thumbnail">
													<img src="${path}/template/images/faces/face2.jpg"
														alt="image" class="profile-pic">
												</div>
												<div class="preview-item-content flex-grow">
													<h6 class="preview-subject ellipsis font-weight-normal">Tim
									...
									<li class="nav-item dropdown mr-0"><a
										...
										id="notificationDropdown" href="#" data-toggle="dropdown">
											<i class="typcn typcn-bell mx-0"></i> <span class="count"></span>
									</a>
										<div
											class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
											aria-labelledby="notificationDropdown">
											...
											<a class="dropdown-item preview-item">
												...
												<div class="preview-item-content">
													<h6 class="preview-subject font-weight-normal">New
                ...
                <span class="typcn typcn-th-menu"></span>
						...
						</nav> <!-- 기존 민트색 상단바--> <!-- partial -->
						<nav
							class="navbar-breadcrumb col-xl-12 col-12 d-flex flex-row p-0"
							style="background: #007FFF;">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-prepend">
							...
							<div class="navbar-links-wrapper d-flex align-items-stretch">
								<div class="nav-link"
									style="border-right: none; flex-grow: 0.1;">
									<a onclick="location.href='${path}/adMain.do'"><i
										class="mdi mdi-desktop-mac"></i></a>
								</div>
								<div class="nav-link"
                ...
                <i class="typcn typcn-cog-outline"></i>
							...
							<div id="right-sidebar" class="settings-panel">
								...
								<ul class="nav nav-tabs" id="setting-panel" role="tablist">
									<li class="nav-item"><a class="nav-link active"
										id="todo-tab" data-toggle="tab" href="#todo-section"
										role="tab" aria-controls="todo-section" aria-expanded="true">TO
											DO LIST</a></li>
									<li class="nav-item"><a class="nav-link" id="chats-tab"
										data-toggle="tab" href="#chats-section" role="tab"
										aria-controls="chats-section">CHATS</a></li>
								...
								<div class="tab-content" id="setting-content">
									<div class="tab-pane fade show active scroll-wrapper"
										...
										<div class="events py-4 border-bottom px-3">
											<div class="wrapper d-flex mb-2">
												<i
													class="typcn typcn-media-record-outline text-primary mr-2"></i>
												<span>Feb 11 2018</span>
											</div>
									...
									<div class="tab-pane fade" id="chats-section" role="tabpanel"
										...
										<ul class="chat-list">
											<li class="list active">
												<div class="profile">
													<img src="${path}/template/images/faces/face1.jpg"
											...
											<li class="list">
												<div class="profile">
													<img src="${path}/template/images/faces/face3.jpg"
														alt="image"><span class="online"></span>
												</div>
												<div class="info">
													<p>Daniel Russell</p>
											...
											<li class="list">
												<div class="profile">
													<img src="${path}/template/images/faces/face5.jpg"
														alt="image"><span class="online"></span>
												</div>
												<div class="info">
													<p>Madeline Kennedy</p>
											...
											<li class="list">
												<div class="profile">
													<img src="${path}/template/images/faces/face6.jpg"
														alt="image"><span class="online"></span>
												</div>
												<div class="info">
													<p>Sarah Graves</p>
							...
							<nav class="sidebar sidebar-offcanvas" id="sidebar">
								<ul class="nav">
									<li class="nav-item"><a class="nav-link"
										href="${path}/projList"> <i
											class="tpycn mdi mdi-airplay menu-icon"></i> <span
									...
									<li class="nav-item"><a class="nav-link"
										...
										aria-expanded="false" aria-controls="form-elements"> <i
											class="tpycn mdi mdi-account-check menu-icon"></i> <span
											class="menu-title">사용자관리</span> <!-- <i class="menu-arrow"></i> -->
									</a> <!-- <div class="collapse" id="form-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link"
                                href="pages/forms/basic_elements.jsp">Basic Elements</a>
									...
									<li class="nav-item"><a class="nav-link"
										href="${path}/task"> <i
											class="tpycn mdi mdi-file-export menu-icon"></i> <span
											class="menu-title">업무할당관리</span> <!-- <i class="menu-arrow"></i> -->
									</a> <!-- <div class="collapse" id="form-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link"
                                href="pages/forms/basic_elements.jsp">Basic Elements</a>
									...
									<li class="nav-item"><a class="nav-link"
										href="${path}/taskManage"> <i
											class="tpycn mdi mdi-checkbox-marked-circle menu-icon"></i> <span
											class="menu-title">업무현황관리</span> <!-- <i class="menu-arrow"></i> -->
									</a> <!-- <div class="collapse" id="charts">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                            <a class="nav-link" href="pages/charts/chartjs.jsp">ChartJs</a>
									...
									<li class="nav-item"><a class="nav-link" href="#tables">
											<i class="tpycn mdi mdi-file-check menu-icon"></i> <span
											class="menu-title">결재관리</span> <!-- <i class="menu-arrow"></i> -->
									</a> <!-- <div class="collapse" id="tables">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                            <a class="nav-link" href="pages/tables/basic-table.jsp">Basic table</a>
									...
									<li class="nav-item"><a class="nav-link"
										href="${path}/noticeList"> <i
											class="tpycn mdi mdi-tooltip-text menu-icon"></i> <span
											class="menu-title">공지사항관리</span> <!-- <i class="menu-arrow"></i> -->
									</a> <!-- <div class="collapse" id="icons">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                            <a class="nav-link" href="pages/icons/mdi.jsp">Mdi icons</a>
									...
									<li class="nav-item"><a class="nav-link"
										...
										aria-controls="auth"> <i
											class="tpycn mdi mdi-account-plus menu-icon"></i> <span
											class="menu-title">권한요청관리</span> <!-- <i class="menu-arrow"></i> -->
									</a> <!-- <div class="collapse" id="auth">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                            <a class="nav-link" href="pages/samples/login.jsp"> Login </a>
                            ...
                            <a class="nav-link" href="pages/samples/register.jsp"> Register </a>
									...
									<li class="nav-item"><a class="nav-link"
										href="${path}/insertUser"> <i
											class="tpycn mdi mdi-account-multiple-plus menu-icon"
											style="width: 20px; height: 20px;"></i> <span
											class="menu-title">사용자 초대</span>
									</a></li>


									<li class="nav-item"><a class="nav-link"
										href="${path}/userIndex"> <i
											class="tpycn mdi mdi-account-convert menu-icon"> </i> <span
											class="menu-title">일반유저페이지</span> <!-- <i class="menu-arrow"></i> -->
									</a> <!-- <div class="collapse" id="auth">
						</div> --></li>
							...
							<script>
								...
								function getCurrentDate() {
									...
									var monthNames = [ "Jan", "Feb", "Mar",
											"Apr", "May", "Jun", "Jul", "Aug",
											"Sep", "Oct", "Nov", "Dec" ];
									var month = monthNames[currentDate
											.getMonth()];
								...
								document
										.addEventListener(
												...
												function() {
													document
															.getElementById('currentDate').innerText = 'Today: '
															+ getCurrentDate();
												});
							</script>