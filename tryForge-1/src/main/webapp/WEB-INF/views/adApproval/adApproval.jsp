...
<script>
    ...
    function aplist(){
        ...
        $("#form01 [name=project_key]").val(projectKey);
        $("#form01 [name=assignor]").val("${loginMem.member_name}")
        $.ajax({
            url: "${path}/approvalList",
...
<form id="form01">
    ...
    <input type="hidden" name="assignor"/>
</form>
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-md-12" style="margin-top: 3%;">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">처리완료 결재</h4>
                        <!-- 완료된 프로젝트 테이블 -->
                        <div class="table-responsive" style="width: 95%; margin-left: 4%;">
                            <table class="table table-hover" style="width: 100%;">
                                <thead>
